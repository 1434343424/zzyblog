...
Post.getOne = (name,minute,title,callback)=>{
    mongo.open((err,db)=>{
        if(err){
            return callback(err);
        }
...
Post.edit = (name,minute,title,callback)=>{
    mongo.open((err,db)=>{
        if(err){
            return callback(err);
        }
...
//修改操作
Post.update = (name,minute,title,post,callback)=>{
    mongo.open((err,db)=>{
        if(err){
            return callback(err);
        }
...
//删除操作
Post.remove = (name,minute,title,callback)=>{
    mongo.open((err,db)=>{
        if(err){
            return callback(err);
        }
